...
#AC 5_6_7 (Current Queue actions, shuffle and clear queue validation)
    ...
    And I select Home tab from the navigation menu
    Then I am on the Homepage
    When I select Album tab from the navigation menu #code to be implemented in Homepage
    Then I am on the Album page #code to be implemented in Album Page
    And I double click to play a song from the Album page #code to be implemented in Album Page
    Then I verify that I am navigated to the Current Queue page #code to be implemented in Current Queue
    When I select shuffle all songs button #code to be implemented in Current Queue
    Then I verify that the songs in the Current Queue page are shuffled #code to be implemented in Current Queue
